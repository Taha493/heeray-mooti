  ...
  return (
    <div className={`sidebar ${isOpen ? "open" : ""}`}>
      ...
      <ul>
        ...
        <li onClick={() => handleCategoryClick("Handmade Ring")}>
          Handmade Rings
        </li>
        <li onClick={() => handleCategoryClick("Handmade Earring")}>
          Handmade Earrings
        </li>
        <li onClick={() => handleCategoryClick("Handmade Set")}>
          Handmade Sets
        </li>
        <li onClick={() => handleCategoryClick("Premade Ring")}>
          Premade Rings
        </li>
        <li onClick={() => handleCategoryClick("Premade Earring")}>
          Premade Earrings
        </li>
        <li onClick={() => handleCategoryClick("Premade Chain")}>
          Premade Chains
        </li>
      ...
      <div className="social-icons">
        <a
          href="https://www.instagram.com/handycollection2024/"
          target="_blank"
